...
urlpatterns = [
    ...
    path(r'Display/<slug:groupname>/<slug:operation>/<int:Users_pk>', views.change_members, name="change_members"),
    #path(r'<int:pk>', views.view_group_byPK,name='view-group'),
    path('create/', views.CreateGroup, name='create_group'),
    #path('change/<slug:groupname>', views.CreateGroup, name='create_group'),
